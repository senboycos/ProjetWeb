 ...
 */
final class Version20220415230905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__utilisateur AS SELECT id, login, motdepasse, nom, prenom, isadmin FROM utilisateur');
        $this->addSql('DROP TABLE utilisateur');
        $this->addSql('CREATE TABLE utilisateur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(40) NOT NULL, motdepasse VARCHAR(40) NOT NULL, nom VARCHAR(40) NOT NULL, prenom VARCHAR(40) NOT NULL, isadmin BOOLEAN NOT NULL, date_aniv DATE NOT NULL)');
        $this->addSql('INSERT INTO utilisateur (id, login, motdepasse, nom, prenom, isadmin) SELECT id, login, motdepasse, nom, prenom, isadmin FROM __temp__utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__utilisateur AS SELECT id, login, motdepasse, nom, prenom, isadmin FROM utilisateur');
        $this->addSql('DROP TABLE utilisateur');
        $this->addSql('CREATE TABLE utilisateur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(40) NOT NULL, motdepasse VARCHAR(40) NOT NULL, nom VARCHAR(40) NOT NULL, prenom VARCHAR(40) NOT NULL, isadmin BOOLEAN NOT NULL, date_naissance DATETIME NOT NULL)');
        $this->addSql('INSERT INTO utilisateur (id, login, motdepasse, nom, prenom, isadmin) SELECT id, login, motdepasse, nom, prenom, isadmin FROM __temp__utilisateur');
        $this->addSql('DROP TABLE __temp__utilisateur');
    }
}
